...
def transmission_scheduling(base_station, simulation_time=1000):
	...
	scheduling = {
		...
		'BU-aggr': LBPS.bottom_up('aggr', base_station, simulation_time),
		'BU-split': LBPS.bottom_up('split' ,base_station, simulation_time),
		'BU-merge': LBPS.bottom_up('merge', base_station, simulation_time)
	}
